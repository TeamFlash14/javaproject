...
<header>
	<div class="container">
        ...
        <input type="checkbox" id="drop" />
            <ul class="menu mt-2">
                <li class="mr-lg-3 mr-2"><a href="index.jsp">Home</a></li>
...
<% int nop = Integer.parseInt(request.getParameter("nop"));
   ...
   if (budget.equals("economical"))	{
	   
	   a = 25000+(nop*500);
   }
   else if (budget.equals("mid"))	{
	   a = 50000+(nop*1000);
   }
...
<div align = "center"><font face="verdana" color="green">
<h4>Your approximate budget is around</h4> <h1>&#x20b9 <% out.print(a); %></h1>
</font>
</div>
<br/>
                        ...
                        <div class="generic_head_price clearfix">
                            ...
                            <div class="generic_price_tag clearfix">    
                                <span class="price">
                                    ...
                                    <span class="cent">000 base rate</span>
                                </span>
                            </div>
                            <!--//PRICE END-->
                        ...
                        <div class="generic_head_price clearfix">
                            ...
                            <div class="generic_price_tag clearfix">    
                                <span class="price">
                                    ...
                                    <span class="cent">00,000 base rate</span>
